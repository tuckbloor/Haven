...
var _sfc_main$18 = {
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="landing-page" data-v-cc160636><header class="site-header" data-v-cc160636><div class="header-inner" data-v-cc160636><div class="brand" data-v-cc160636><div class="brand-icon" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M3 11.5L12 4l9 7.5" data-v-cc160636></path><path d="M5 10.5V20h14v-9.5" data-v-cc160636></path><path d="M9 20v-6h6v6" data-v-cc160636></path></svg></div><span class="brand-name" data-v-cc160636>Haven</span></div><nav class="main-nav" data-v-cc160636><a href="#features" data-v-cc160636>Features</a><a href="#how-it-works" data-v-cc160636>How It Works</a><a href="#about" data-v-cc160636>About</a></nav><div class="auth-actions" data-v-cc160636>`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/login",
				class: "btn btn-login"
			}, {
			...
			_push(`</div></div></header><main data-v-cc160636><section class="hero" data-v-cc160636><div class="hero-inner" data-v-cc160636><div class="hero-copy" data-v-cc160636><div class="hero-badge" data-v-cc160636><span class="hero-badge-dot" data-v-cc160636></span> Smart home control made simple </div><h1 data-v-cc160636> A smarter home <span data-v-cc160636>every single day</span></h1><p class="hero-description" data-v-cc160636> Monitor, control and automate your home with a simple, secure interface designed to keep everything in one place. </p><div class="hero-actions" data-v-cc160636>`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/register",
			...
			_push(`<a href="#features" class="btn btn-secondary btn-large" data-v-cc160636> Explore Features </a></div><div class="hero-points" data-v-cc160636><div class="hero-point" data-v-cc160636><span class="point-icon" data-v-cc160636>✓</span> Easy device control </div><div class="hero-point" data-v-cc160636><span class="point-icon" data-v-cc160636>✓</span> Flexible automations </div><div class="hero-point" data-v-cc160636><span class="point-icon" data-v-cc160636>✓</span> Home monitoring </div></div></div><div class="hero-visual" data-v-cc160636><div class="home-preview-card" data-v-cc160636><div class="preview-top" data-v-cc160636><div data-v-cc160636><span class="preview-label" data-v-cc160636> My Home </span><h2 data-v-cc160636>Everything connected</h2></div><div class="online-status" data-v-cc160636><span class="online-dot" data-v-cc160636></span> Online </div></div><div class="preview-grid" data-v-cc160636><div class="preview-stat" data-v-cc160636><span data-v-cc160636>Devices</span><strong data-v-cc160636>12</strong><small data-v-cc160636>10 online</small></div><div class="preview-stat" data-v-cc160636><span data-v-cc160636>Automations</span><strong data-v-cc160636>8</strong><small data-v-cc160636>6 active</small></div><div class="preview-stat" data-v-cc160636><span data-v-cc160636>Rooms</span><strong data-v-cc160636>6</strong><small data-v-cc160636>Fully connected</small></div><div class="preview-stat" data-v-cc160636><span data-v-cc160636>Alerts</span><strong data-v-cc160636>0</strong><small data-v-cc160636>No action needed</small></div></div><div class="room-card" data-v-cc160636><div data-v-cc160636><strong data-v-cc160636>Living Room</strong><span data-v-cc160636>3 devices connected</span></div><span class="room-status" data-v-cc160636> Active </span></div></div></div></div></section><section id="features" class="features-section" data-v-cc160636><div class="section-heading" data-v-cc160636><span data-v-cc160636>Everything in one place</span><h2 data-v-cc160636> Simple control for your entire home </h2><p data-v-cc160636> Haven gives you the tools to manage devices, create automations and keep an eye on your home. </p></div><div class="features-inner" data-v-cc160636><article class="feature-card" data-v-cc160636><div class="feature-icon" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M9 18h6" data-v-cc160636></path><path d="M10 22h4" data-v-cc160636></path><path d="M8.5 14.5A6 6 0 1 1 15.5 14.5C14.5 15.2 14 16 14 17H10C10 16 9.5 15.2 8.5 14.5Z" data-v-cc160636></path></svg></div><h3 data-v-cc160636>Control</h3><p data-v-cc160636> Manage lights, switches and smart devices from one place. </p></article><article class="feature-card" data-v-cc160636><div class="feature-icon" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M13 2L4 14h7l-1 8 9-12h-7z" data-v-cc160636></path></svg></div><h3 data-v-cc160636>Automate</h3><p data-v-cc160636> Create routines that react to schedules, conditions and events. </p></article><article class="feature-card" data-v-cc160636><div class="feature-icon" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7z" data-v-cc160636></path><path d="m9 12 2 2 4-4" data-v-cc160636></path></svg></div><h3 data-v-cc160636>Stay Safe</h3><p data-v-cc160636> See important alerts and recent activity across your home. </p></article><article class="feature-card" data-v-cc160636><div class="feature-icon" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M12 2v20" data-v-cc160636></path><path d="M5 9h14" data-v-cc160636></path><path d="M7 9c0-4 2-7 5-7s5 3 5 7" data-v-cc160636></path><path d="M7 9c0 6 2 11 5 13 3-2 5-7 5-13" data-v-cc160636></path></svg></div><h3 data-v-cc160636>Save Energy</h3><p data-v-cc160636> Track usage and make smarter decisions around your home. </p></article></div></section><section id="how-it-works" class="how-section" data-v-cc160636><div class="section-heading" data-v-cc160636><span data-v-cc160636>How it works</span><h2 data-v-cc160636> Your smarter home in three steps </h2><p data-v-cc160636> Haven keeps setup straightforward so you can get started quickly. </p></div><div class="steps" data-v-cc160636><div class="step-card" data-v-cc160636><div class="step-number" data-v-cc160636>1</div><h3 data-v-cc160636>Create your account</h3><p data-v-cc160636> Register for Haven and create your first home. </p></div><div class="step-card" data-v-cc160636><div class="step-number" data-v-cc160636>2</div><h3 data-v-cc160636>Add your devices</h3><p data-v-cc160636> Organise devices into homes and rooms. </p></div><div class="step-card" data-v-cc160636><div class="step-number" data-v-cc160636>3</div><h3 data-v-cc160636>Create automations</h3><p data-v-cc160636> Build schedules and rules that make everyday tasks easier. </p></div></div></section><section id="about" class="cta-section" data-v-cc160636><div class="cta-card" data-v-cc160636><div data-v-cc160636><span class="cta-small" data-v-cc160636> Ready to get started? </span><h2 data-v-cc160636> Build your smarter home with Haven. </h2><p data-v-cc160636> Create your account and start organising your smart home today. </p></div>`);
			_push(ssrRenderComponent(unref(Link), {
				href: "/register",
				class: "btn btn-primary btn-large"
			}, {
			...
			_push(`</div></section></main><footer class="site-footer" data-v-cc160636><div class="footer-inner" data-v-cc160636><div class="brand" data-v-cc160636><div class="brand-icon small" data-v-cc160636><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-cc160636><path d="M3 11.5L12 4l9 7.5" data-v-cc160636></path><path d="M5 10.5V20h14v-9.5" data-v-cc160636></path><path d="M9 20v-6h6v6" data-v-cc160636></path></svg></div><span class="brand-name" data-v-cc160636> Haven </span></div><p data-v-cc160636> Smart home control made simple. </p></div></footer></div><!--]-->`);
		};
	}
};
...
var Home_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$18, [["__scopeId", "data-v-cc160636"]]);
//#endregion
